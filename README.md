...
![Authentification](Z-images/01_authentification.png)
...
![Gestion des congés Admin](Z-images/04_gestion_conges_admin.png)
...
![Demande de congé User](Z-images/05_demande_conge_user.png)
...
![Calendrier des congés](Z-images/06_calendrier_conges.png)
...
![Pipeline ETL SSIS](Z-images/07_etl_talend_pipeline.png)
...
![Dashboard Power BI](Z-images/08_etl_talend_transformation.png)
